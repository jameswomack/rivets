...
(function() {
  ...
  Rivets.View = (function() {
    ...
    View.prototype.build = function() {
      ...
      parse = function(node) {
        var attribute, attributes, binder, binding, context, ctx, dependencies, identifier, keypath, model, multiple, multiples, n, options, path, pipe, pipes, regexp, splitPath, type, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
        if (__indexOf.call(skipNodes, node) < 0) {
          ...
          for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
            ...
            if (bindingRegExp.test(attribute.name)) {
              ...
              for (_l = 0, _len3 = multiples.length; _l < _len3; _l++) {
                multiple = multiples[_l];
                multiple = multiple.trim();
                type = attribute.name.replace(bindingRegExp, '');
                pipes = (function() {
                  var _len4, _m, _ref4, _results;
                  _ref4 = multiple.split('|');
                  _results = [];
